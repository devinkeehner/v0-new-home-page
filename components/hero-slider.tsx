        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12">
          <div className="flex flex-col justify-center text-white">
              ...
              >
                {index === 0 ? (
                  <h1 className="mb-4 text-5xl font-bold tracking-tight md:text-6xl lg:text-7xl">
                    <span className="block text-[#FFD700]">Connecticut</span>
                    <span className="block text-[#FFD700]">House</span>
                    <span className="block text-[#FFD700]">Republicans</span>
                  </h1>
                ) : (
            ...
            <div className="w-full max-w-md mt-auto">
              {formSubmitted ? (
                <Alert className="border-green-500 bg-green-50 bg-opacity-20 text-white border-white/30">
                  <CheckCircle className="h-5 w-5 text-white" />
                  <AlertTitle className="text-white">Thank you for signing up!</AlertTitle>
                  <AlertDescription className="text-white/90">
                    You've been successfully added to our mailing list. We'll keep you updated with the latest news and
                    information.
                  </AlertDescription>
                  <Button
                    onClick={resetForm}
          ...
          <div className="flex items-center justify-center relative">
            <div className="relative h-64 w-64 overflow-hidden rounded-full border-4 border-white md:h-80 md:w-80 hover-highlight">
              <Image
