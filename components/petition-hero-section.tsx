...
export function PetitionHeroSection() {
  ...
  const [displayedSignatureCount, setDisplayedSignatureCount] = useState(0) // Keep for potential future use
  ...
  useEffect(() => {
    ...
    const targetCount = actualSignatureCount + 49 // The logic to add 49
    ...
    const animateCount = () => {
      ...
      if (progress < 1) {
        ...
        setDisplayedSignatureCount(targetCount)
      }
    }
    // Start animation from 0 or current displayed if less than target
    setDisplayedSignatureCount((prev) => (prev < targetCount ? prev : 0))
    animationFrameId.current = requestAnimationFrame(animateCount)
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          <div className="flex flex-col justify-between">
            ...
            <div className="bg-black rounded-lg shadow-xl overflow-hidden max-w-sm">
              <div className="aspect-[9/16]">
                <iframe
                  src="https://www.youtube.com/embed/veTHr1T76Bc?autoplay=1&mute=1" // Mute for better autoplay probability
          ...
          <div className="bg-white rounded-lg p-8 shadow-xl h-full">
            ...
            {/* Signature count display can be added here if needed:
            <p className="text-center text-primary-navy text-3xl font-bold mb-4">
              {displayedSignatureCount.toLocaleString()} Voices Strong
            </p>
            */}
            {submitted ? (
